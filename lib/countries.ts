...
/**
 * Everywhere else, alphabetically — every country there is.
 *
 * This list was once a short one of the places members were expected to be.
 * That was a mistake: a member in a country nobody thought of cannot fill
 * the form at all, and the Society has no business telling him his country
 * does not exist. Keep it complete.
 */
